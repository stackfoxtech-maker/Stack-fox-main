...
const POSTS = [
  {
    ...
    excerpt:
      "A deep dive into serverless architecture, database sharding, and why your first choice of tech stack matters more than you think.",
    ...
    content:
      "Scaling a web application from a minimum viable product to handling 100,000 concurrent users is one of the most challenging journeys in software engineering...",
  ...
  },
  {
    ...
    excerpt:
      "Stop using ChatGPT as a toy. Learn how to integrate LLMs into your internal workflows to save 20+ hours a week.",
    category: "AI",
    featured: true,
    ...
    content:
      "Generative AI has moved far beyond chatbots and image generators. Forward-thinking businesses are now integrating large language models directly into their internal workflows...",
  ...
  },
  {
    ...
    excerpt:
      "The average Indian user has a budget smartphone and intermittent 4G. Here is how to design apps that actually work.",
    category: "Design",
    featured: true,
    ...
    content:
      "India's mobile-first market presents unique challenges that most Western design frameworks simply don't address...",
  ...
  },
  {
    ...
    excerpt:
      "You don't need Kubernetes on day one. A pragmatic guide to shipping fast with GitHub Actions, Docker, and Railway.",
    category: "DevOps",
    featured: false,
    ...
    content:
      "The DevOps landscape can feel overwhelming for a small team. But the truth is, you can achieve reliable deployments with a fraction of the tooling...",
  ...
  },
  {
    ...
    excerpt:
      "A technical comparison of payment gateways for Indian e-commerce, including UPI autopay, subscriptions, and compliance.",
    category: "E-Commerce",
    featured: false,
    ...
    content:
      "India's payment ecosystem is unique. UPI dominates consumer transactions, but enterprise billing still relies heavily on NEFT and RTGS...",
