...
- **Neutrals — warm** (`warm-white #FAF8F5`, `warm-50 #F5F3EF`, `warm-100 #EDEAE4`, `warm-200 #DEDAD1`, `warm-300 #C6C1B5`, `warm-400 #9C968A`, `warm-500 #756F63`, `warm-600 #57524A`, `warm-700 #3E3A34`, `warm-800 #2A2723`, `warm-900 #1A1918`). Slightly warmer and a touch more saturated than the old set; token names unchanged so nothing breaks.
