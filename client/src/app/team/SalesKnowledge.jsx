    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-9 pr-4 py-3 rounded-xl border border-warm-200 text-sm focus:outline-none focus:ring-2 focus:ring-fox-500/30"
        />
      </div>
      ...
      <div className="space-y-4">
        {filtered.map((topic) => {
          ...
          return (
            <div
              key={topic.id}
              className="bg-white rounded-2xl border border-warm-200 overflow-hidden hover:shadow-sm transition"
            >
              <button
              ...
              {isExpanded && (
                <div className="px-5 pb-5 border-t border-warm-100 space-y-4">
                  <div>
                    <h4 className="text-xs font-semibold text-warm-500 uppercase tracking-wide mb-1">
                      Simple Explanation
                    </h4>
                  ...
                  <div className="p-4 rounded-xl bg-fox-50 border border-fox-100">
                    <h4 className="text-xs font-semibold text-fox-700 uppercase tracking-wide mb-1">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {topic.commonQuestions.map((q, idx) => (
                        <div
                          key={idx}
                          className="flex items-start gap-2 p-3 rounded-xl bg-warm-50 border border-warm-100"
                        >
