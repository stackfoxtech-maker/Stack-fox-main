    ...
    return (
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          <Link to="/app/team/projects" className="p-2 hover:bg-warm-100 rounded-lg">
            <ArrowLeft size={18} />
          </Link>
    ...
    <div className="space-y-4">
      ...
      {projects.length === 0 ? (
        <EmptyState
          ...
          description="You'll see projects here when assigned by an admin."
        />
      ) : (
