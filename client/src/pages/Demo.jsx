...
export default function Demo() {
    ...
    return (
      <div className="max-w-xl mx-auto px-6 py-24 text-center">
        ...
        <p className="text-gray-600 mb-8">
          A StackFox expert will reach out within 2 business hours to schedule your personalized
          demo.
        </p>
      </div>
    );
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-16">
      ...
      <p className="text-gray-600 mb-8">
        30-minute walkthrough of how StackFox accelerates software delivery with AI.
      </p>
      ...
      <form onSubmit={submit} className="bg-white border rounded-2xl p-6 space-y-5">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="e.g. hiring slow, missed deadlines, budget overruns…"
            className="w-full border rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-500 min-h-[100px]"
          />
        </div>
        <button
          type="submit"
