      ...
      <div className="min-h-screen bg-warm-50 flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl border border-warm-200 p-10 text-center max-w-md">
          ...
          <p className="text-warm-500 text-sm">
            Our team will review it and get back to <strong>{form.email}</strong> within 2 business
            days. Have a brief document? Reply to our confirmation email with it attached.
          </p>
          <a
            href="/"
            className="inline-block mt-5 text-fox-500 font-semibold text-sm hover:underline"
          >
            Back to home
          </a>
        </div>
    ...
    <div className="min-h-screen bg-warm-50 py-10 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-warm-500 mb-8">
          Tell us about your project and we will prepare a detailed proposal.
        </p>
        ...
        <div className="bg-white rounded-2xl border border-warm-200 p-6 space-y-5">
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full border border-warm-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-fox-500/30"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full border border-warm-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-fox-500/30 bg-white"
            >
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full border border-warm-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-fox-500/30 resize-none"
          ...
          <button
            ...
            className={`w-full py-3 rounded-xl font-semibold flex items-center justify-center gap-2 transition ${canSubmit && !busy ? 'bg-fox-500 text-white hover:bg-fox-600' : 'bg-warm-200 text-warm-400 cursor-not-allowed'}`}
          >
