...
const templates = [
  {
    ...
    sections: ['Definitions', 'Obligations', 'Term & Termination', 'Remedies'],
  },
  {
    id: 'sla',
    name: 'Service Level Agreement',
    desc: 'Define service expectations, uptime guarantees, and support response times.',
    sections: ['Service Scope', 'Performance Metrics', 'Penalties', 'Reporting'],
  },
  {
    id: 'msa',
    name: 'Master Service Agreement',
    desc: 'Establish the overarching terms for an ongoing business relationship.',
    sections: ['Scope of Work', 'Payment Terms', 'IP Rights', 'Liability'],
  },
  {
    id: 'privacy',
    name: 'Privacy Policy',
    desc: 'Comply with data protection regulations and inform users of data practices.',
    sections: ['Data Collection', 'Usage', 'Third Parties', 'User Rights'],
  },
  {
    id: 'tos',
    name: 'Terms of Service',
    desc: 'Set the rules and guidelines users agree to when using your platform.',
    sections: ['Eligibility', 'Acceptable Use', 'Termination', 'Disclaimers'],
  },
];
            ...
            <div className="flex items-start justify-between">
                  ...
                  <div className="bg-warm-50 rounded-xl p-4 mb-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {t.sections.map((s) => (
                        <span
                          key={s}
                          className="text-xs bg-white border border-warm-200 rounded-full px-3 py-1 text-warm-700"
                        >
                          {s}
                        </span>
                      ))}
              ...
              <div className="flex gap-2 shrink-0 ml-4">
                <button
                  ...
                  className="flex items-center gap-1 text-sm text-warm-500 hover:text-warm-700 border border-warm-200 rounded-xl px-4 py-2"
                >
