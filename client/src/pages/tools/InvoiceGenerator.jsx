      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-warm-200 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                onClick={addItem}
                className="text-fox-500 hover:text-fox-600 text-sm flex items-center gap-1"
              >
              ...
              {items.map((it, i) => (
                <div key={i} className="flex gap-2 items-center">
                  ...
                  <input
                    ...
                    className="w-16 border border-warm-200 rounded-lg px-2 py-2 text-sm text-center"
                  />
                  <input
                    type="number"
                    min="0"
                    ...
                    className="w-24 border border-warm-200 rounded-lg px-2 py-2 text-sm"
                    placeholder="Rate"
                  />
                  {items.length > 1 && (
                    <button
            ...
            <div className="mt-4 flex items-center gap-2">
              ...
              <input
                ...
                className="w-20 border border-warm-200 rounded-lg px-3 py-2 text-sm"
              />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-warm-200 p-6">
          ...
          <table className="w-full text-sm mb-6">
            <thead>
              <tr className="text-warm-500 border-b border-warm-100">
            ...
            <tbody>
              {items.map((it, i) => (
                <tr key={i} className="border-b border-warm-50">
                  ...
                  <td className="py-2 text-right text-warm-900">
          ...
          <div className="space-y-1 text-sm">
            ...
            <div className="flex justify-between text-warm-900 font-bold text-lg pt-2 border-t border-warm-200">
              <span>Total</span>
