        ...
        <div className="container-fx">
          ...
          <Reveal stagger className="mt-12 grid gap-5 md:grid-cols-3">
            {STEPS.map((s, i) => (
              <Reveal.Item
                key={s.title}
                className="rounded-md border border-warm-200 bg-warm-white p-6 shadow-sm"
              >
                <div className="mb-5 flex items-center gap-3">
                  <span className="grid h-9 w-9 place-items-center rounded-pill bg-sage-50 font-mono text-sm text-sage-700">
                    {i + 1}
                  </span>
