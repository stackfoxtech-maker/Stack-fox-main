...
const pages = {
  ...
  '/legal/sla': {
    ...
    content:
      'For clients on maintenance retainers: we guarantee 99.9% uptime for managed infrastructure, response time under 4 hours for critical issues, and under 24 hours for non-critical issues. Monthly reporting includes uptime metrics, incident logs, and performance summaries. SLA credits apply when targets are missed.',
  },
};
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-body-md text-warm-600 leading-relaxed space-y-4">
          ...
          <p className="text-sm text-warm-400 mt-8">
            Last updated: January 2025. For questions, email stackfox.tech@gmail.com.
          </p>
        </div>
      </div>
    </Section>
