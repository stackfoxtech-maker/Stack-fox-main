...
const services = {
  1: {
    ...
    delivery: '15–20 days',
    description:
      'Full-stack custom website built with modern technologies. Includes responsive design, CMS integration, SEO-ready structure, and deployment. We handle everything from wireframes to launch so you can focus on your business.',
  },
  2: {
    ...
    delivery: '7–10 days',
    description:
      'Comprehensive on-page and off-page SEO audit and implementation. Keyword research, meta tag optimization, content strategy, backlink analysis, and Google Search Console setup included.',
  },
  3: {
    name: 'Logo Design',
    category: 'Design',
    ...
    delivery: '3–5 days',
    description:
      'Professional logo design with 3 initial concepts, unlimited revisions on the chosen direction, and final delivery in all formats (SVG, PNG, PDF). Brand color palette and typography guide included.',
  },
  4: {
    ...
    delivery: '30–45 days',
    description:
      'Cross-platform mobile application built with React Native. Includes UI/UX design, API integration, push notifications, and app store submission for both iOS and Android.',
  },
};
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl border border-warm-200 p-8">
          <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
            <div>
              <span className="text-xs font-semibold uppercase tracking-wider text-fox-500 bg-fox-500/10 px-3 py-1 rounded-full">
                {service.category}
              </span>
            ...
            <div className="text-right">
              ...
              <p className="text-sm text-warm-500 flex items-center gap-1 justify-end mt-1">
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 rounded-xl font-semibold transition ${added ? 'bg-green-500 text-white' : 'bg-fox-500 text-white hover:bg-fox-600'}`}
            >
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {related
              ...
              .map((r) => (
                <a
                  key={r.id}
                  href={`/service?id=${r.id}`}
                  className="bg-white rounded-2xl border border-warm-200 p-5 hover:border-fox-500/40 transition block"
                >
