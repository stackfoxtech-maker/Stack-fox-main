...
const programs = [
  {
    ...
    description:
      'Refer businesses to StackFox and earn cash rewards for every client that signs up. No limits on referrals — the more you share, the more you earn.',
  ...
  },
  {
    ...
    description:
      'White-label our services or co-deliver projects. Get priority support, co-branded collateral, and revenue sharing on every deal.',
  ...
  },
  {
    ...
    description:
      'Building something new? Get up to 40% off on development, design, and marketing services. Available for startups under 2 years old with less than ₹2Cr revenue.',
  ...
  },
  {
    ...
    description:
      'Dedicated account teams, SLA-backed delivery, volume pricing, and custom integrations for large organizations with ongoing needs.',
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-warm-500 max-w-xl mx-auto">
            Grow with StackFox — whether you are referring clients, partnering as an agency,
            launching a startup, or scaling an enterprise.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {programs.map((prog) => (
            <div
              key={prog.title}
              className="bg-white rounded-2xl border border-warm-200 p-6 flex flex-col"
            >
              <div
                className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 ${colorMap[prog.color]}`}
              >
                <prog.icon size={22} />
              </div>
