...
const allServices = [
  {
    ...
    price: 45000,
    delivery: '15–20 days',
    description: 'Full-stack custom website with responsive design, CMS, and SEO.',
  },
  {
    id: 2,
    ...
    price: 15000,
    delivery: '7–10 days',
    description: 'On-page/off-page SEO audit, keyword research, and implementation.',
  },
  {
    id: 3,
    name: 'Logo Design',
    ...
    price: 5000,
    delivery: '3–5 days',
    description: 'Professional logo with 3 concepts, revisions, and full file delivery.',
  },
  {
    id: 4,
    ...
    price: 120000,
    delivery: '30–45 days',
    description: 'Cross-platform React Native app with UI/UX and store submission.',
  },
  {
    id: 5,
    ...
    price: 20000,
    delivery: '5–7 days',
    description: 'Strategy, content calendar, and management for 3 platforms.',
  },
  {
    id: 6,
    name: 'Brand Identity',
    ...
    price: 25000,
    delivery: '10–14 days',
    description: 'Complete branding: logo, colors, typography, and brand guidelines.',
  },
];
...
export default function Compare() {
  ...
  const addSlot = () => {
    if (selected.length < 4) setSelected([...selected, 0]);
  };
  const removeSlot = (i) => setSelected(selected.filter((_, idx) => idx !== i));
  const changeSlot = (i, id) => {
    const next = [...selected];
    next[i] = Number(id);
    setSelected(next);
  };
              ...
              <tr className="border-b border-warm-200">
                  ...
                  <th key={i} className="p-4 min-w-[180px]">
                    <div className="flex items-center gap-2">
                      <select
                        ...
                        className="flex-1 border border-warm-200 rounded-lg px-3 py-2 text-sm font-medium text-warm-900 focus:outline-none focus:ring-2 focus:ring-fox-500/30 bg-white"
                      >
                ...
                {selected.length < 4 && (
                  <th className="p-4">
                    <button
                      onClick={addSlot}
                      className="flex items-center gap-1 text-fox-500 text-sm font-medium hover:text-fox-600"
                    >
                      <Plus size={16} /> Add
                    </button>
                  </th>
